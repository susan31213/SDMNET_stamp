...
path = '/home/susan/SDMNET_stamp/code/python/chair_reproduce/encode_decode'
sdm, recovers, symf = model.simple_encode_decode1(datainfo, path)
os.system(f'matlab -nojvm -batch "cd \'/home/susan/SDMNET_stamp/code/matlab\'; GetOptimizedObj2(\'{path}\', \'chair\', 2, 1, 0, 1, {5})"')
# os.system(f'matlab -nojvm -batch "cd \'/home/susan/SDMNET_stamp/code/matlab\'; GetOptimizedObjGT(\'{path}\', \'chair\', 2, 1, 0, 1, {1})"')
...
#     latent = np.array(np.load(args.latent)['z'])
        
#     print('start inference...')
#     model.simple_encode_decode(sess, datainfo, path)
# os.system(f'matlab -nojvm -batch "cd \'/home/susan/SDMNET_stamp/code/matlab\'; GetOptimizedObj2(\'{path}\', \'chair\', 2, 1, 0, 1, {1})"')
# os.system(f'matlab -nojvm -batch "cd \'/home/susan/SDMNET_stamp/code/matlab\'; GetOptimizedObjGT(\'{path}\', \'chair\', 2, 1, 0, 1, {1})"')